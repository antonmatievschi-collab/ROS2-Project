...
: ${AMENT_CURRENT_PREFIX:="/home/sarris/ros2_myproject/install/my_package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_package/environment/library_path.sh"
